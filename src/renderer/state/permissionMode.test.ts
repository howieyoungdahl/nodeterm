...
// `sessionIdFlag` and `nameFlag` are unrelated to what these fixtures exercise (the `auto` version
// gate); they are spelled out only because ClaudeCliCaps requires them.
