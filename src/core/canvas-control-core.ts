...
export function parseControlRequest(
  ...
  if (['send', 'reply', 'notify'].includes(v) &&
    ['message', 'message_id', 'action_id'].some((key) => key in args)) return {
    error: 'identified-message-requires-trusted-host-route: legacy messaging cannot accept identity claims. Do not retry.'
  }
...
export function buildCanvasControlInstructions(shimPath: string): string {
  ...
  return [
    ...
    '- `open-claude [--count N] [--cwd P] [--prompt T | --prompt-file F] [--model M] [--size compact|normal] [--group <id>] [--after <id,id>] [--project <id>]` — open N Claude sessions.',
    `- \`open-agent --agent ${agentChoices} [--count N] [--cwd P] [--prompt T | --prompt-file F] [--model M] [--size compact|normal] [--remote-control[=NAME]] [--group <id>] [--after <id,id>] [--project <id>]\` — open`,
...
- \`open-claude [--count N] [--cwd P] [--prompt T | --prompt-file F] [--model M] [--size compact|normal] [--group <id>] [--after <id,id>] [--project <id>]\` — open N Claude sessions (default 1).
- \`open-agent --agent ${agentChoices} [--count N] [--cwd P] [--prompt T | --prompt-file F] [--model M] [--size compact|normal] [--remote-control[=NAME]] [--group <id>] [--after <id,id>] [--project <id>]\` — open N sessions of any agent CLI.
