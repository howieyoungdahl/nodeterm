...
[AGENT-REFERENCE.md](./AGENT-REFERENCE.md) is the deep reference behind them;
coding agents start at [AGENTS.md](./AGENTS.md). Questions or bug reports are also happy at
